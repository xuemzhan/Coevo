...
const blocked=[/\bgit\s+push\b/i,/\bgit\s+reset\s+--hard\b/i,/\bgit\s+clean\b/i,/\brm\s+-rf\b/i,/\bdel\s+\/s\b/i,/\bformat\s+[a-z]:/i,/\bcurl\b/i,/\bwget\b/i,/\bInvoke-WebRequest\b/i,/\b(iwr|irm)\b/i,/\b(npm|bun|pip|pip3)\s+install\b/i,/\bpython\s+-m\s+pip\s+install\b/i,/\bgo\s+get\b/i]
