...
| US-15 安全审计 | `E2E_VERIFIED`；归档重锚定 `PROTOTYPE`（REVIEW2-10 独立安全审查已通过，2026-08-12） | 哈希链+签名 fully-sealed |
| US-16 框架层（CTAF） | `INTEGRATION_VERIFIED` | manifest/policy/plan/hybrid/k8s 清单全测试；CTAF 提案 v0.4.1 独立架构评审已通过（2026-08-12），可作为实施基线 |
