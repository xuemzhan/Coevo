...
## 2026-08-10T02:11:16.639336Z — target=`fmt` fingerprint=`8d456a2ce09245c7`
- exit_code: `0`
```text
preflight audit seal: fully-sealed
$ C:\Python314\python.exe -m compileall -q -f scripts src tests
...
## 2026-08-10T02:12:09.072129Z — target=`lint` fingerprint=`5103146e112f2dd1`
- exit_code: `14`
```text
...
$ C:\Python314\python.exe E:\Workspace\Coevo\scripts\audit_seal.py verify --allow-tail
{"ok": true, "status": "fully-sealed"}
stage audit seal failed: [WinError 5] 拒绝访问。: 'E:\\Workspace\\Coevo\\loop\\audit-head.json.pending' -> 'E:\\Workspace\\Coevo\\loop\\audit-head.json'

```


## 2026-08-10T02:13:41.108205Z — target=`lint` fingerprint=`5103146e112f2dd1`
- exit_code: `0`
```text
": "test",
          "path": "tests/integration/test_agent_package_atomic_import.py",
...
## 2026-08-10T02:17:55.335048Z — target=`quality` fingerprint=`f742f64aa8dce72c`
- exit_code: `1`
```text
raceability_check.TraceabilityTests.test_us_5_ac_1_matrix_lists_src_and_test) ... ok
test_us_5_ac_2_is_done_with_evidence (test_traceability_check.TraceabilityTests.test_us_5_ac_2_is_done_with_evidence) ... ok
test_us_5_ac_2_matrix_lists_src_and_test (test_traceability_check.TraceabilityTests.test_us_5_ac_2_matrix_lists_src_and_test) ... ok
test_us_5_ac_3_is_done_with_evidence (test_traceability_check.TraceabilityTests.test_us_5_ac_3_is_done_with_evidence) ... ok
test_us_5_ac_3_matrix_lists_src_and_test (test_traceability_check.TraceabilityTests.test_us_5_ac_3_matrix_lists_src_and_test) ... ok
...
Traceback (most recent call last):
  File "E:\Workspace\Coevo\tests\unit\test_release_check.py", line 84, in test_real_backlog_matches_state
    self.assertEqual([], [i for i in non_done if i != current], non_done)
    ~~~~~~~~~~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
AssertionError: Lists differ: [] != ['ARCH-REVIEW-2', 'ARCH-REVIEW-3', 'ARCH-R[89 chars]W-9']
...
+  'ARCH-REVIEW-7',
+  'ARCH-REVIEW-8',
+  'ARCH-REVIEW-9'] : ['ARCH-REVIEW-1', 'ARCH-REVIEW-2', 'ARCH-REVIEW-3', 'ARCH-REVIEW-4', 'ARCH-REVIEW-5', 'ARCH-REVIEW-6', 'ARCH-REVIEW-7', 'ARCH-REVIEW-8', 'ARCH-REVIEW-9']

----------------------------------------------------------------------
Ran 1380 tests in 128.349s
...
[gate] records self-trim: [verification] archive 9 section(s): archived 9 old section(s); size 504063 > 500000 bytes; size-trimmed 9 kept section(s);   -> wrote E:\Workspace\Coevo\loop\archive\20260810\verification-20260810.txt; [ok] decisions: nothing to archive

## 2026-08-10T02:42:15.574881Z — target=`quality` fingerprint=`f742f64aa8dce72c`
- exit_code: `0`
```text
ests.test_promote_failure_requires_recovery_and_reopen_commits_exactly_once) ... ok
test_row_shape_validator_rejects_each_oversize_and_malformed_column (test_merge_receipt_repository.MergeReceiptRepositorySecurityTests.test_row_shape_validator_rejects_each_oversize_and_malformed_column) ... ok
...
## 2026-08-10T02:57:00.242919Z — target=`fmt` fingerprint=`8d456a2ce09245c7`
- exit_code: `0`
```text
preflight audit seal: fully-sealed
$ C:\Python314\python.exe -m compileall -q -f scripts src tests
...
## 2026-08-10T02:57:13.804818Z — target=`fmt` fingerprint=`8d456a2ce09245c7`
- exit_code: `0`
```text
preflight audit seal: fully-sealed
$ C:\Python314\python.exe -m compileall -q -f scripts src tests
...
## 2026-08-10T02:59:33.008762Z — target=`quality` fingerprint=`f742f64aa8dce72c`
- exit_code: `1`
```text
traceability_check.TraceabilityTests.test_us_5_ac_1_matrix_lists_src_and_test) ... ok
test_us_5_ac_2_is_done_with_evidence (test_traceability_check.TraceabilityTests.test_us_5_ac_2_is_done_with_evidence) ... ok
test_us_5_ac_2_matrix_lists_src_and_test (test_traceability_check.TraceabilityTests.test_us_5_ac_2_matrix_lists_src_and_test) ... ok
test_us_5_ac_3_is_done_with_evidence (test_traceability_check.TraceabilityTests.test_us_5_ac_3_is_done_with_evidence) ... ok
test_us_5_ac_3_matrix_lists_src_and_test (test_traceability_check.TraceabilityTests.test_us_5_ac_3_matrix_lists_src_and_test) ... ok
...
----------------------------------------------------------------------
Ran 1380 tests in 66.659s

FAILED (failures=1, skipped=3)

```

## 2026-08-10T03:01:54.162777Z — target=`quality` fingerprint=`f742f64aa8dce72c`
- exit_code: `1`
```text
ac_1_matrix_lists_src_and_test (test_traceability_check.TraceabilityTests.test_us_5_ac_1_matrix_lists_src_and_test) ... ok
test_us_5_ac_2_is_done_with_evidence (test_traceability_check.TraceabilityTests.test_us_5_ac_2_is_done_with_evidence) ... ok
test_us_5_ac_2_matrix_lists_src_and_test (test_traceability_check.TraceabilityTests.test_us_5_ac_2_matrix_lists_src_and_test) ... ok
test_us_5_ac_3_is_done_with_evidence (test_traceability_check.TraceabilityTests.test_us_5_ac_3_is_done_with_evidence) ... ok
test_us_5_ac_3_matrix_lists_src_and_test (test_traceability_check.TraceabilityTests.test_us_5_ac_3_matrix_lists_src_and_test) ... ok
...
Traceback (most recent call last):
  File "E:\Workspace\Coevo\tests\unit\test_release_check.py", line 84, in test_real_backlog_matches_state
    self.assertEqual([], [i for i in non_done if i != current], non_done)
    ~~~~~~~~~~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
AssertionError: Lists differ: [] != ['ARCH-REVIEW-3', 'ARCH-REVIEW-4', 'ARCH-R[72 chars]W-9']
...
+  'ARCH-REVIEW-7',
+  'ARCH-REVIEW-8',
+  'ARCH-REVIEW-9'] : ['ARCH-REVIEW-2', 'ARCH-REVIEW-3', 'ARCH-REVIEW-4', 'ARCH-REVIEW-5', 'ARCH-REVIEW-6', 'ARCH-REVIEW-7', 'ARCH-REVIEW-8', 'ARCH-REVIEW-9']

----------------------------------------------------------------------
Ran 1380 tests in 72.912s

FAILED (failures=1, skipped=3)

```

## 2026-08-10T03:07:42.568908Z — target=`fmt` fingerprint=`8d456a2ce09245c7`
- exit_code: `0`
```text
preflight audit seal: fully-sealed
$ C:\Python314\python.exe -m compileall -q -f scripts src tests
...
## 2026-08-10T03:08:19.937714Z — target=`lint` fingerprint=`5103146e112f2dd1`
- exit_code: `0`
```text
": "test",
          "path": "tests/integration/test_agent_package_atomic_import.py",
